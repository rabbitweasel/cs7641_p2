...
public class NNGenetic {

    FixedData data;

    public NNGenetic(FixedData data) {
        this.data = data;
    }
    ...
    public void run() {
        ...
        for (int j=0; j<iterations; j++) {
            ...
            FeedForwardNetwork networkTrain = factory.createClassificationNetwork(new int[]{122, 100, 1});
            FeedForwardNetwork networkTest = factory.createClassificationNetwork(new int[]{122, 100, 1});
            ...
            OptimizationAlgorithm o = new StandardGeneticAlgorithm(100, 20, 5, nno);
            FixedIterationTrainer fit = new FixedIterationTrainer(o, 100); // 5000
            fit.train();
