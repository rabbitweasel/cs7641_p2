...
public class MaxKColoringTest {
    ...
    private static final int L =7; // L adjacent nodes per vertex
    ...
    public static void main(String[] args) {
        ...
        while (conflict) {
            ...
            fit.train();
            count++;
            conflict = ef.conflict;
            //System.out.println("GA: " + ef.value(ga.getOptimal()));
            //System.out.println(ef.foundConflict());
            //System.out.println("Time : " + (System.currentTimeMillis() - starttime));
        }
        System.out.println("GA restarts needed: " + count);
        System.out.println("Time : "+ (System.currentTimeMillis() - starttime));
        ...
        System.out.println("MIMIC restarts needed: " + count);
        System.out.println("Time : "+ (System.currentTimeMillis() - starttime));
    }
}
